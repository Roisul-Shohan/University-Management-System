...
export const createDepartment = async (payload: CreateDepartmentInput) => {
	...
	if (existingDepartment) {
		...
		throw new AppError(409, "A department with this code already exists.");
	}
...
export const deleteDepartment = async (id: string) => {
	...
	if (department.courses.length > 0) {
		throw new AppError(409, "Cannot delete department because it has courses.");
	}
